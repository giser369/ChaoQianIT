<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/MstPage_L0.master" AutoEventWireup="true" CodeFile="dotnetlist.aspx.cs" Inherits="GIS_GISList" %>
            ...
            <ItemTemplate>
                <div class="divlistitem">
                    <div class="fl">
                        ...
                        <a href='dotnetdetail.aspx?order=<%#Eval("ArtOrder") %>&type=<%#Eval("ArtType") %>'><%#Eval("ArtTitle") %></a>
                    </div>
