<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/MstPage_L0.master" AutoEventWireup="true" CodeFile="ToolList.aspx.cs" Inherits="Tool_ToolList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
            ...
            <ItemTemplate>
                <div class="divlistitem">
                    ...
                    <div class="fl"">
                        ...
                        <a href='<%#Eval("ToolUrl") %>?order=<%#Eval("ToolOrder") %>'><%#Eval("Name") %></a>
                    </div>
                    <div style="float:right;"><p><%#Eval("Date","{0:D}") %></p></div>
                    <div class="clr"></div>
        ...
        <%-- ListView的数据源 --%>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:qds114476253_dbConnectionString %>" SelectCommand="SELECT * FROM [T_TOOL_MANAGER]">
            <SelectParameters>
                <asp:Parameter DefaultValue="1" Name="ArtType" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
