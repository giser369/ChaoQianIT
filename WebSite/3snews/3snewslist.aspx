<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/MstPage_L0.master" AutoEventWireup="true" CodeFile="3SNewsList.aspx.cs" Inherits="_3SNews_3SNewsList" %>
        ...
        <asp:ListView ID="ListView1" runat="server" ItemPlaceholderID="itemHolder" DataSourceID="SqlDataSource1">
            ...
            <ItemTemplate>
                <div class="divlistitem">
                    <div class="fl">
                        <div class="divlistitem_head"></div><a href='3snewsdetail.aspx?order=<%#Eval("ArtOrder") %>&type=<%#Eval("ArtType") %>'><%#Eval("ArtTitle") %></a>
                    </div>
