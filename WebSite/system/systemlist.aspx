<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/MstPage_L0.master" AutoEventWireup="true" CodeFile="systemlist.aspx.cs" Inherits="Download_DownloadList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
            ...
            <ItemTemplate>
                <div class="divlistitem">
                    ...
                    <div class="fl"">
                        ...
                        <a href='systemdetail.aspx?order=<%#Eval("ArtOrder") %>&type=<%#Eval("ArtType") %>'><%#Eval("ArtTitle") %></a>
                    </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:qds114476253_dbConnectionString %>" SelectCommand="SELECT * FROM [T_ARTICLE] WHERE ([ArtType] = @ArtType)">
            <SelectParameters>
                <asp:Parameter DefaultValue="4" Name="ArtType" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
