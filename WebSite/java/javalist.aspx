<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/MstPage_L0.master" AutoEventWireup="true" CodeFile="javalist.aspx.cs" Inherits="Coding_CodingList" %>
            ...
            <ItemTemplate>
                <div class="divlistitem">
                    ...
                    <div class="fl"">
                        ...
                        <a href='javadetail.aspx?order=<%#Eval("ArtOrder") %>&type=<%#Eval("ArtType") %>'><%#Eval("ArtTitle") %></a>
                    </div>
