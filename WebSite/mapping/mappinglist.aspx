<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/MstPage_L0.master" AutoEventWireup="true" CodeFile="MappingList.aspx.cs" Inherits="Mapping_MappingList" %>
        ...
        <asp:ListView ID="ListView1" runat="server" ItemPlaceholderID="itemHolder" DataSourceID="SqlDataSource1">
            ...
            <ItemTemplate>
                <div class="divlistitem">
                    <div class="fl">
                        <div class="divlistitem_head"></div><a href='mappingdetail.aspx?order=<%#Eval("ArtOrder") %>&type=<%#Eval("ArtType") %>'><%#Eval("ArtTitle") %></a>
                    </div>
