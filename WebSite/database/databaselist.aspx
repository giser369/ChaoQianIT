<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/MstPage_L0.master" AutoEventWireup="true" CodeFile="databaselist.aspx.cs" Inherits="_3SNews_3SNewsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    <div class="div-artlist">
        <asp:ListView ID="ListView1" runat="server" ItemPlaceholderID="itemHolder" DataSourceID="SqlDataSource1">
            ...
            <ItemTemplate>
                <div class="divlistitem">
                    <div class="fl">
                        <div class="divlistitem_head"></div><a href='databasedetail.aspx?order=<%#Eval("ArtOrder") %>&type=<%#Eval("ArtType") %>'><%#Eval("ArtTitle") %></a>
                    </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:qds114476253_dbConnectionString %>" SelectCommand="SELECT * FROM [T_ARTICLE] WHERE ([ArtType] = @ArtType)">
            <SelectParameters>
                <asp:Parameter DefaultValue="3" Name="ArtType" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
